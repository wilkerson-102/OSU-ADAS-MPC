classdef casadi_block < matlab.System & matlab.system.mixin.Propagates
    ...
    % TEST - Do changes transfer over symbolic windows links?
...
%             opti.set_initial(sol.value_variables())
        ...
        function u = stepImpl(obj,reld,relv,af,vf,afref,ap,razzle)     
            % Convert to distance error from desired
            r = 1;
            tauh = 1;
            vf_high = 25;
            vf_low = 10;
